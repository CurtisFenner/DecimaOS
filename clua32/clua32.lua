...
function allDeclarations(source)
	local idens = {};
...
function clua32(src, main)
	local source = stripComments(loadFile(src));
	local identifiers = allDeclarations(source);
